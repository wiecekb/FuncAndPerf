...
modifierRegistry.register<CalcRequestBuilder>(CalcModifiedParameter.A, (b: CalcRequestBuilder, v: string) =>
  b.withA(parseInt(v, 10))
);
modifierRegistry.register<CalcRequestBuilder>(CalcModifiedParameter.B, (b: CalcRequestBuilder, v: string) =>
  b.withB(parseInt(v, 10))
);
...
export function splitCalcModifyRequests(modifyRequests: ModifyRequest[]): {
